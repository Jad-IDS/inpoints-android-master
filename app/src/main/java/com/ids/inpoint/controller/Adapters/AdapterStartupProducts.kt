...
class AdapterStartupProducts(private val context: Context, val items: ArrayList<ResponseStartupProduct>,
    private val itemClickListener: RVOnItemClickListener
) :
    RecyclerView.Adapter<AdapterStartupProducts.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvSubTitle1.text = items[position].description
