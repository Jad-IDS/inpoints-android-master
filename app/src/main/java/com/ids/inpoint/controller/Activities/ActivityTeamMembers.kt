...
//        }
        ...
        adapterGridTeamMember =
            AdapterGridTeamMember(teamMembers, this, teamAdmin)
    ...
    private fun filterUsers(word: String) {
        if (MyApplication.arrayUsers.size > 0) {
            ...
            var notMembers =
                MyApplication.arrayUsers.filter { ru -> teamMembers.all { it.userId != ru.id } }
    ...
    override fun onItemClicked(view: View, position: Int) {
        when (view.id) {
            ...
            R.id.btDelete -> {
                teamMember = teamMembers[position]
            ...
            R.id.btEdit -> {
                ...
                etUser.setText(teamMembers[position].name)
                swAdmin.isChecked = teamMembers[position].admin == true
                edit = false
                etUser.isEnabled = false
                btClear.isEnabled = false
            }
                ...
                if (MyApplication.userLoginInfo.id!! == teamMembers[position].userId!!) {
